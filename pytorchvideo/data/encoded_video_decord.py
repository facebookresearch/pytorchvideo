...
class EncodedVideoDecord(Video):
    ...
    def get_clip(
        ...
        start_idx = int(round(self._fps * start_sec))
        num_frames = int(round(self._fps * (end_sec - start_sec)))
        end_idx = min(start_idx + num_frames, len(self._av_reader))
